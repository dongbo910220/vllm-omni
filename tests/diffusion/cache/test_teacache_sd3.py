...
def test_sd3_teacache_default_coefficients() -> None:
    cfg = TeaCacheConfig(transformer_type="SD3Transformer2DModel")
    assert cfg.coefficients == [0.0, 0.0, 0.0, 4.0, 0.0]


def test_sd3_extractor_registry() -> None:
